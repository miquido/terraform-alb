# terraform-alb <a href="https://miquido.com"><img align="right" src="https://cdn.miquido.dev/miquido-logo.png" width="150" /></a>

Terraform module for Application Load Balancer along with AWS ACM TLS/SSL certificate via ACM Request.
...
```hcl
module "alb" {
  source = "git@gitlab.com:miquido/terraform/terraform-alb.git?ref=x.x.x"
...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_alb"></a> [alb](#module\_alb) | cloudposse/alb/aws | 2.1.0 |
